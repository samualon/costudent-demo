 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wb="FirebaseError";class yn extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Wb,Object.setPrototypeOf(this,yn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,gs.prototype.create)}}class gs{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?zb(i,r):"Error",c=`${this.serviceName}: ${o} (${s}).`;return new yn(s,c,r)}}function zb(t,e){return t.replace(Qb,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Qb=/\{\$([^}]+)}/g;function Yb(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function uo(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],o=e[s];if(gp(i)&&gp(o)){if(!uo(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function gp(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const eR="firebase-heartbeat-database",tR=1,ho="firebase-heartbeat-store";let Vl=null;function iy(){return Vl||(Vl=ry(eR,tR,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ho)}catch(n){console.warn(n)}}}}).catch(t=>{throw Rr.create("idb-open",{originalErrorMessage:t.message})})),Vl}async function nR(t){try{const n=(await iy()).transaction(ho),r=await n.objectStore(ho).get(oy(t));return await n.done,r}catch(e){if(e instanceof yn)ss.warn(e.message);else{const n=Rr.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ss.warn(n.message)}}}async function wp(t,e){try{const r=(await iy()).transaction(ho,"readwrite");await r.objectStore(ho).put(e,oy(t)),await r.done}catch(n){if(n instanceof yn)ss.warn(n.message);else{const r=Rr.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ss.warn(r.message)}}}function oy(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fo(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof yn&&IR(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function IR({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oS(t,e,n=!1){const{auth:r}=t;if(un(r.app))return Promise.reject(Hn(r));const s="reauthenticate";try{const i=await fo(t,by(r,s,e,t),n);me(i.idToken,r,"internal-error");const o=Ah(i.idToken);me(o,r,"internal-error");const{sub:c}=o;return me(t.uid===c,r,"user-mismatch"),os._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&sn(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ry(t,e,n=!1){if(un(t.app))return Promise.reject(Hn(t));const r="signIn",s=await by(t,r,e),i=await os._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function aS(t,e){return Ry(rr(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sy(t){const e=rr(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function cS(t,e,n){const r=rr(t);await Za(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",XR)}async function lS(t,e,n){if(un(t.app))return Promise.reject(Hn(t));const r=rr(t),o=await Za(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",sS).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&Sy(t),l}),c=await os._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function uS(t,e,n){return un(t.app)?Promise.reject(Hn(t)):aS(it(t),ci.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Sy(t),r})}function hS(t,e,n,r){return it(t).onIdTokenChanged(e,n,r)}function dS(t,e,n){return it(t).beforeAuthStateChanged(e,n)}function Cy(t,e,n,r){return it(t).onAuthStateChanged(e,n,r)}function fS(t){return it(t).signOut()}const tc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const NS=new No(2e3,1e4);async function Uy(t,e,n){if(un(t.app))return Promise.reject(dn(t,"operation-not-supported-in-this-environment"));const r=rr(t);hR(t,e,Ch);const s=xy(r,n);return new Wr(r,"signInViaPopup",e,s).executeNotNull()}class Wr extends Fy{constructor(e,n,r,s,i){super(e,n,s,i),this.provider=r,this.authWindow=null,this.pollId=null,Wr.currentPopupAction&&Wr.currentPopupAction.cancel(),Wr.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return me(e,this.auth,"internal-error"),e}async onExecution(){Wn(this.filter.length===1,"Popup operations only handle one event");const e=Ph();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(n=>{this.reject(n)}),this.resolver._isIframeWebStorageSupported(this.auth,n=>{n||this.reject(dn(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)===null||e===void 0?void 0:e.associatedEvent)||null}cancel(){this.reject(dn(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,Wr.currentPopupAction=null}pollUserCancellation(){const e=()=>{var n,r;if(!((r=(n=this.authWindow)===null||n===void 0?void 0:n.window)===null||r===void 0)&&r.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(dn(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,NS.get())};e()}}Wr.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const QS=new No(3e4,6e4);function Fp(){const t=In().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function YS(t){return new Promise((e,n)=>{var r,s,i;function o(){Fp(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Fp(),n(dn(t,"network-request-failed"))},timeout:QS.get()})}if(!((s=(r=In().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=In().gapi)===null||i===void 0)&&i.load)o();else{const c=BR("iframefcb");return In()[c]=()=>{gapi.load?o():n(dn(t,"network-request-failed"))},Iy(`${UR()}?onload=${c}`).catch(l=>n(l))}}).catch(e=>{throw ka=null,e})}let ka=null;function JS(t){return ka=ka||YS(t),ka}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vC(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function EC(t){Sn(new mn("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;me(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:c,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:wy(t)},u=new LR(r,s,i,l);return KR(u,n),u},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Sn(new mn("auth-internal",e=>{const n=rr(e.getProvider("auth").getImmediate());return(r=>new yC(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),rn($p,jp,vC(t)),rn($p,jp,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cv="installations",BP="installations-internal",$P=t=>{const e=t.getProvider("app").getImmediate(),n=UP(e),r=ms(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},jP=t=>{const e=t.getProvider("app").getImmediate(),n=ms(e,cv).getImmediate();return{getId:()=>LP(n),getToken:s=>xP(n,s)}};function qP(){Sn(new mn(cv,$P,"PUBLIC")),Sn(new mn(BP,jP,"PRIVATE"))}qP();rn(Ky,Dh);rn(Ky,Dh,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wc{constructor(e,n,r,s,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const s=new Map;return s.set(e,$o.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Wc(ye.min(),s,new Je(Me),Qn(),Ie())}}class $o{constructor(e,n,r,s,i){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new $o(r,n,Ie(),Ie(),Ie())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fc(t){t=Yn(t,Ut);const e=Yn(t.firestore,pi);return sD(od(e),t._key).then(n=>bD(e,t,n))}class LE extends TD{constructor(e){super(),this.firestore=e}convertBytes(e){return new ii(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Ut(this.firestore,null,n)}}function $n(t){t=Yn(t,fi);const e=Yn(t.firestore,pi),n=od(e),r=new LE(e);return vD(t._query),iD(n,t._query).then(s=>new ID(e,r,t,s))}function Bu(t,e,n,...r){t=Yn(t,Ut);const s=Yn(t.firestore,pi),i=ud(s);let o;return o=typeof(e=it(e))=="string"||e instanceof Zc?gD(i,"updateDoc",t._key,e,n,r):pD(i,"updateDoc",t._key,e),md(s,[o.toMutation(t._key,fn.exists(!0))])}function xE(t){return md(Yn(t.firestore,pi),[new Kh(t._key,fn.none())])}function $u(t,e){const n=Yn(t.firestore,pi),r=Un(t),s=wD(t.converter,e);return md(n,[fD(ud(t.firestore),"addDoc",r._key,s,t.converter!==null,{}).toMutation(r._key,fn.exists(!1))]).then(()=>r)}function md(t,e){return function(r,s){const i=new Kn;return r.asyncQueue.enqueueAndForget(async()=>KO(await rD(r),s,i)),i.promise}(od(t),e)}function bD(t,e,n){const r=n.docs.get(e._key),s=new LE(t);return new ME(t,s,e._key,r,new Bi(n.hasPendingWrites,n.fromCache),e.converter)}(function(e,n=!0){(function(s){ui=s})(ai),Sn(new mn("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),c=new pi(new R1(r.getProvider("auth-internal")),new k1(r.getProvider("app-check-internal")),function(u,h){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new ne(q.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new _o(u.options.projectId,h)}(o,s),o);return i=Object.assign({useFetchStreams:n},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),rn(Zp,"4.6.3",e),rn(Zp,"4.6.3","esm2017")})();const RD={apiKey:"AIzaSyAwTIEXjpkeBLeoSBTn_5riMFb2BXx0O1g",authDomain:"costudent-808bd.firebaseapp.com",projectId:"costudent-808bd",storageBucket:"costudent-808bd.appspot.com",messagingSenderId:"849831118304",appId:"1:849831118304:web:c75efa2fc3ff1d16885785",measurementId:"G-18V5HBXXS4"},nl=sy(RD);E1(nl);const eo=li(nl),at=lD(nl),SD=t=>(Jn("data-v-94b9d04c"),t=t(),Xn(),t),CD={class:"container"},PD={class:"loginWindow"},kD=SD(()=>V("h1",null,"WELCOME",-1)),OD={class:"buttonBox"},DD={__name:"Login",setup(t){function e(){uS(eo,o,c).then(l=>{i.push({name:"dashboard"}),je("success","Successfully logged in!")}).catch(l=>{switch(l.message){case"Firebase: Error (auth/invalid-credential).":je("error","Wrong password!");break;case"Firebase: Error (auth/invalid-email).":je("error","Wrong email adress!");break;case"Firebase: Error (auth/too-many-requests).":je("error","Our servers are currently overloaded :(");break;default:je("error",l.message);break}})}function n(){cS(eo,o).then(()=>{je("success","Password reset email sent! Be sure to check your SPAM folder.")}).catch(l=>{l.message=="Firebase: Error (auth/missing-email)."&&je("error","Enter your email adress in the 'Email' field first!")})}function r(){Uy(eo,s).then(l=>{je("success","Successfully logged in!"),Vt.credentialFromResult(l).accessToken,l.user,i.push("/dashboard")}).catch(l=>{je("error",l.message),l.code,l.message,l.customData.email,Vt.credentialFromError(l)})}const s=new Vt,i=Oo();_h();let o,c="";return(l,u)=>(Te(),Pe("div",CD,[V("div",PD,[kD,wn(V("input",{type:"email",autocomplete:"email",placeholder:"Email",id:"userEmail","onUpdate:modelValue":u[0]||(u[0]=h=>Ze(o)?o.value=h:o=h)},null,512),[[hn,st(o)]]),wn(V("input",{type:"password",autocomplete:"current-password",placeholder:"Password",id:"userPassword","onUpdate:modelValue":u[1]||(u[1]=h=>Ze(c)?c.value=h:c=h),onKeydown:u[2]||(u[2]=Oc(h=>e(),["enter"]))},null,544),[[hn,st(c)]]),V("div",OD,[V("button",{class:"button_white",onClick:u[3]||(u[3]=h=>e())},"Login"),V("div",{id:"googleLogin",class:"button_white",onClick:u[4]||(u[4]=h=>r())},"Log in with Google")]),V("a",{onClick:u[5]||(u[5]=h=>n())},"Forgot password?")])]))}},ND=xr(DD,[["__scopeId","data-v-94b9d04c"]]),VD=t=>(Jn("data-v-01e98b37"),t=t(),Xn(),t),MD={class:"container"},LD={class:"loginWindow"},xD=VD(()=>V("h1",null,"CREATE ACCOUNT",-1)),FD={__name:"Register",setup(t){function e(){lS(eo,o,c).then(u=>{u.user,i.push("/FindCostudent"),je("success","Successfully registered!")}).catch(u=>{switch(u.message){case"Firebase: Error (auth/email-already-in-use).":je("error","An account already exists for this email!");break;case"Firebase: Error (auth/invalid-email).":je("error","Invalid email!");break;case"Firebase: Error (auth/invalid-password).":je("error","Invalid password!");break;case"Firebase: Password should be at least 6 characters (auth/weak-password).":je("error","Password is too short! It should be at least 6 characters.");break;case"Firebase: Error (auth/too-many-requests).":je("error","Our servers are currently overloaded :(");break;default:je("error",u.message);break}})}function n(){i.push("/login")}function r(){Uy(eo,s).then(u=>{je("success","Successfully logged in!"),Vt.credentialFromResult(u).accessToken,u.user,i.push("/")}).catch(u=>{je("error",u.message),u.code,u.message,u.customData.email,Vt.credentialFromError(u)})}const s=new Vt,i=Oo();_h();let o,c,l="";return(u,h)=>(Te(),Pe("div",MD,[V("div",LD,[xD,wn(V("input",{type:"email",placeholder:"Email",id:"userEmail","onUpdate:modelValue":h[0]||(h[0]=p=>Ze(o)?o.value=p:o=p)},null,512),[[hn,st(o)]]),wn(V("input",{type:"password",placeholder:"Password",id:"userPassword","onUpdate:modelValue":h[1]||(h[1]=p=>Ze(c)?c.value=p:c=p)},null,512),[[hn,st(c)]]),wn(V("input",{type:"password",placeholder:"Password",id:"userPasswordConfirm","onUpdate:modelValue":h[2]||(h[2]=p=>Ze(l)?l.value=p:l=p),onKeydown:h[3]||(h[3]=Oc(p=>e(),["enter"]))},null,544),[[hn,st(l)]]),V("button",{class:"button_white",onClick:e},"Create account"),V("button",{id:"googleLogin",class:"button_white",onClick:h[4]||(h[4]=p=>r())},"Login with Google"),V("p",null,[ln("Already have an account? "),V("a",{onClick:n},"Login here!")])])]))}},UD=xr(FD,[["__scopeId","data-v-01e98b37"]]),ot=t=>(Jn("data-v-5debb613"),t=t(),Xn(),t),BD={class:"container"},$D={class:"formBox"},jD={class:"progressBar"},qD={class:"phase"},HD={class:"phase"},KD={class:"phase"},GD={key:0,class:"entry"},WD={class:"itemBox"},zD=ot(()=>V("p",null,"Subject",-1)),QD=ot(()=>V("option",{value:"",disabled:""},"Select a subject",-1)),YD=["value"],JD={class:"itemBox"},XD=ot(()=>V("p",null,"Location",-1)),ZD=ot(()=>V("option",{value:"",disabled:""},"Select a location",-1)),eN=["value"],tN={class:"itemBox",id:"date"},nN=ot(()=>V("p",null,"Date",-1)),rN=["min","max"],sN={class:"itemBox",id:"time"},iN={key:1,class:"searching"},oN=ot(()=>V("p",null,"SEARCHING",-1)),aN=ot(()=>V("div",{class:"loader"},null,-1)),cN=[oN,aN],lN={key:2,class:"noneFound"},uN={class:"message"},hN=ot(()=>V("p",null,"No costudents were found yet to study ",-1)),dN={class:"button"},fN=ot(()=>V("p",null," in ",-1)),pN={class:"button"},gN=ot(()=>V("p",null," in the ",-1)),mN={class:"button"},_N=ot(()=>V("p",null," of the ",-1)),yN={class:"button"},vN=ot(()=>V("p",null,".",-1)),EN=ot(()=>V("div",{class:"finalMessage"},[V("p",null,"We'll keep on searching for other costudents."),V("p",null,"You can check in on the progress on your dashboard.")],-1)),TN={class:"buttonBox"},wN={key:3,class:"found"},IN=ot(()=>V("div",{class:"finalMessage"},[V("p",null,"We found costudents!")],-1)),AN={class:"message"},bN=ot(()=>V("p",null,"You can study ",-1)),RN={class:"button"},SN=ot(()=>V("p",null," in ",-1)),CN={class:"button"},PN=ot(()=>V("p",null," in the ",-1)),kN={class:"button"},ON=ot(()=>V("p",null," of the ",-1)),DN={class:"button"},NN=ot(()=>V("p",null," . ",-1)),VN={class:"groupDisplay"},MN=ot(()=>V("p",null,"Your group:",-1)),LN={class:"costudentNames"},xN={class:"buttonBox"},FN={id:"subjects"},UN=["value"],BN={id:"locations"},$N=["value"],jN={__name:"FindCostudent",setup(t){const e=ve=>new Promise(ue=>setTimeout(ue,ve));function n(){const ve=new Date;new Date().setDate(ve.getDate()+21);const fe=ve.getFullYear(),Ne=String(ve.getMonth()+1).padStart(2,"0"),Ve=String(ve.getDate()).padStart(2,"0");return`${fe}-${Ne}-${Ve}`}function r(){const ve=new Date,ue=new Date;ue.setDate(ve.getDate()+21);const fe=ue.getFullYear(),Ne=String(ue.getMonth()+1).padStart(2,"0"),Ve=String(ue.getDate()).padStart(2,"0");return`${fe}-${Ne}-${Ve}`}function s(ve){switch(m.value=!1,y.value=!1,I.value=!1,x.value=ve,ve){case"morning":m.value=!0,k.value=0;break;case"afternoon":y.value=!0,k.value=1;break;case"evening":I.value=!0,k.value=2;break}}async function i(){const ve=Bn(we,Ot("UID","==",A));return!(await $n(ve)).empty}async function o(){await i()?Z.value.includes(U.value)?le.value.includes(O.value)?S.value!=""?k.value!=-1?l():(je("error","Select a time of day!"),c()):(je("error","Select a date!"),c()):(je("error","Select a location from the list!"),c()):(je("error","Select a subject from the list!"),c()):je("error","Set your display name in the dashboard first!")}function c(){U.value="",O.value="",S.value=""}async function l(){D.value=1,await e(2500);const ve=Bn(T,Ot("SUBJ","==",U.value),Ot("LOCATION","==",O.value),Ot("DATE","==",S.value),Ot("TOD","==",k.value)),ue=await $n(ve);if(ue.empty)u();else{const fe=[];for(let Ve=0;Ve<ue.docs[0].data().MEMBERS.length;Ve++)fe.push(ue.docs[0].data().MEMBERS[Ve]);fe.push(A);const Ne=Un(at,"groups",ue.docs[0].id);await Bu(Ne,{MEMBERS:fe}),g(fe),D.value=3}}async function u(){const ve=Bn(ge,Ot("SUBJ","==",U.value),Ot("LOCATION","==",O.value),Ot("DATE","==",S.value),Ot("TOD","==",k.value)),ue=await $n(ve);ue.empty?(h(),D.value=2):p(ue.docs[0].data().UID,ue.docs[0].id)}async function h(){await $u(cn(at,"posts"),{SUBJ:U.value,LOCATION:O.value,DATE:S.value,UID:A,TOD:k.value,POSTDATE:E.value})}async function p(ve,ue){await xE(Un(at,"posts",ue));const fe=[A,ve];await $u(cn(at,"groups"),{DATE:S.value,LOCATION:O.value,MEMBERS:fe,SUBJ:U.value,TOD:k.value}),g(fe),D.value=3}async function g(ve){for(let ue=0;ue<ve.length;ue++){const fe=Bn(we,Ot("UID","==",ve[ue])),Ne=await $n(fe);te.value.push(Ne.docs[0].data().NAME)}}async function w(){const ve=Un(at,"dataLists","locationData"),ue=await fc(ve);le.value=ue.data().locations}async function C(){const ve=Un(at,"dataLists","subjectData"),ue=await fc(ve);Z.value=ue.data().subjects}const M=li(),D=qe(0),U=qe(""),O=qe(""),S=qe(""),k=qe(-1),x=qe("");let P=n(),E=qe(P),_=qe(r());const m=qe(!1),y=qe(!1),I=qe(!1),A=M.currentUser.uid,T=cn(at,"groups"),ge=cn(at,"posts"),we=cn(at,"users"),te=qe([]),le=qe([]),Z=qe([]);return w(),C(),(ve,ue)=>(Te(),Pe("div",BD,[V("div",$D,[V("div",jD,[V("div",qD,[V("p",{class:It({active:D.value===0})},"1",2),V("h3",{class:It({active:D.value===0})},"Enter data",2)]),V("div",{class:It(["line",{completed:D.value>=1}])},null,2),V("div",HD,[V("p",{class:It({active:D.value===1})},"2",2),V("h3",{class:It({active:D.value===1})},"Searching",2)]),V("div",{class:It(["line",{completed:D.value>=2}])},null,2),V("div",KD,[V("p",{class:It({active:D.value===2||D.value===3})},"3",2),V("h3",{class:It({active:D.value===2})},"Results",2)])]),D.value==0?(Te(),Pe("div",GD,[V("div",WD,[zD,wn(V("select",{"onUpdate:modelValue":ue[0]||(ue[0]=fe=>U.value=fe)},[QD,(Te(!0),Pe(He,null,Vn(Z.value,fe=>(Te(),Pe("option",{key:fe,value:fe},Ye(fe),9,YD))),128))],512),[[za,U.value]])]),V("div",JD,[XD,wn(V("select",{"onUpdate:modelValue":ue[1]||(ue[1]=fe=>O.value=fe)},[ZD,(Te(!0),Pe(He,null,Vn(le.value,fe=>(Te(),Pe("option",{key:fe,value:fe},Ye(fe),9,eN))),128))],512),[[za,O.value]])]),V("div",tN,[nN,wn(V("input",{type:"date",id:"date",min:st(E),max:st(_),"onUpdate:modelValue":ue[2]||(ue[2]=fe=>S.value=fe)},null,8,rN),[[hn,S.value]])]),V("div",sN,[V("div",{class:It(["button",{selected:m.value}]),onClick:ue[3]||(ue[3]=fe=>s("morning"))}," Morning ",2),V("div",{class:It(["button",{selected:y.value}]),onClick:ue[4]||(ue[4]=fe=>s("afternoon"))}," Afternoon ",2),V("div",{class:It(["button",{selected:I.value}]),onClick:ue[5]||(ue[5]=fe=>s("evening"))}," Evening ",2)]),V("div",{id:"searchButton",class:"button",onClick:ue[6]||(ue[6]=fe=>o())}," Search ")])):en("",!0),D.value==1?(Te(),Pe("div",iN,cN)):en("",!0),D.value==2?(Te(),Pe("div",lN,[V("div",uN,[hN,V("div",dN,Ye(U.value),1),fN,V("div",pN,Ye(O.value),1),gN,V("div",mN,Ye(x.value),1),_N,V("div",yN,Ye(S.value),1),vN]),EN,V("div",TN,[De(st(gu),{to:"/dashboard",class:"button"},{default:Zt(()=>[ln("Dashboard")]),_:1})])])):en("",!0),D.value==3?(Te(),Pe("div",wN,[IN,V("div",AN,[bN,V("div",RN,Ye(U.value),1),SN,V("div",CN,Ye(O.value),1),PN,V("div",kN,Ye(x.value),1),ON,V("div",DN,Ye(S.value),1),NN]),V("div",VN,[MN,V("div",LN,[(Te(!0),Pe(He,null,Vn(te.value,fe=>(Te(),Pe("div",{class:"button",key:te.value},[V("p",null,Ye(fe),1)]))),128))]),V("div",xN,[De(st(gu),{to:"/dashboard",class:"button"},{default:Zt(()=>[ln("Dashboard")]),_:1})])])])):en("",!0)]),V("datalist",FN,[(Te(!0),Pe(He,null,Vn(Z.value,fe=>(Te(),Pe("option",{key:fe,value:fe},null,8,UN))),128))]),V("datalist",BN,[(Te(!0),Pe(He,null,Vn(le.value,fe=>(Te(),Pe("option",{key:fe,value:fe},null,8,$N))),128))])]))}},qN=xr(jN,[["__scopeId","data-v-5debb613"]]),Ko=t=>(Jn("data-v-f219989a"),t=t(),Xn(),t),HN={class:"container"},KN={class:"titleContainer"},GN=Ko(()=>V("div",{class:"title"},[V("h1",null,"DASHBOARD"),V("p",null,"Here you can find all your requested study sessions and groups that you're a part of.")],-1)),WN={class:"nameContainer"},zN={class:"fieldBox"},QN=Ko(()=>V("p",null,"Display name:",-1)),YN={class:"itemBox"},JN=Ko(()=>V("div",{class:"sectionHeader"},[V("div",{class:"sectionTitle"},[V("h1",null,"YOUR GROUPS")])],-1)),XN={class:"grid"},ZN={class:"groupBox"},eV={class:"groupTitle"},tV={class:"subtle"},nV={class:"labels"},rV={class:"label"},sV={class:"label"},iV={class:"label"},oV={class:"label"},aV={class:"commandButtons"},cV=["onClick"],lV=["onClick"],uV={key:0,class:"noItems"},hV=Ko(()=>V("div",{class:"whiteSpace"},null,-1)),dV={class:"itemBox"},fV=Ko(()=>V("div",{class:"sectionHeader"},[V("div",{class:"sectionTitle"},[V("h1",null,"YOUR POSTS")])],-1)),pV={class:"grid"},gV={class:"postBox"},mV={class:"groupTitle"},_V={class:"labels"},yV={class:"label"},vV={class:"label"},EV={class:"label"},TV={class:"commandButtons"},wV=["onClick"],IV={key:0,class:"noItems"},AV={__name:"Dashboard",setup(t){async function e(){const P=Bn(D,Ot("MEMBERS","array-contains",w)),E=await $n(P);if(E.empty)console.log("No groups");else for(let _=0;_<E.docs.length;_++)n(E.docs[_].data(),E.docs[_].id)}function n(P,E){const _={ID:E,SUBJ:P.SUBJ,LOCATION:P.LOCATION,TOD:P.TOD,DATE:P.DATE,MEMBERS:P.MEMBERS};S.value.push(_)}async function r(P){S.value=S.value.filter(E=>E.ID!=P),s(P)}async function s(P){const E=Un(at,"groups",P);let m=(await fc(E)).data().MEMBERS;m=m.filter(y=>y!==w),await Bu(E,{MEMBERS:m})}function i(P){switch(P){case 0:return"Morning";case 1:return"Afternoon";case 2:return"Evening"}}async function o(){const P=Bn(U,Ot("UID","==",w)),E=await $n(P);if(E.empty)console.log("No posts");else for(let _=0;_<E.docs.length;_++)c(E.docs[_].data(),E.docs[_].id)}function c(P,E){const _={ID:E,SUBJ:P.SUBJ,LOCATION:P.LOCATION,TOD:P.TOD,DATE:P.DATE};k.value.push(_)}async function l(P){k.value=k.value.filter(E=>E.ID!=P),await xE(Un(at,"posts",P))}async function u(){const P=Bn(O,Ot("UID","==",w)),E=await $n(P);E.empty?M=0:(C.value=E.docs[0].data().NAME,M=1)}async function h(){if(M==0)await $u(cn(at,"users"),{UID:w,NAME:C.value}),je("success","Successfully set your username!");else{const P=Bn(O,Ot("UID","==",w)),E=await $n(P),_=Un(at,"users",E.docs[0].id);await Bu(_,{NAME:C.value}),u(),je("success","Successfully updated your username!")}}function p(P,E){const _=E.replace(/\s+/g,"-")+"-"+P.substring(0,6),m=C.value;x.push({name:"group-chat",params:{channel:_},query:{chatName:m,ID:P}})}const w=li().currentUser.uid,C=qe("");let M=0;const D=cn(at,"groups"),U=cn(at,"posts"),O=cn(at,"users"),S=qe([]),k=qe([]),x=Oo();return e(),o(),u(),(P,E)=>(Te(),Pe("div",HN,[V("div",KN,[GN,V("div",WN,[V("div",zN,[QN,wn(V("input",{type:"text","onUpdate:modelValue":E[0]||(E[0]=_=>C.value=_),onKeydown:E[1]||(E[1]=Oc(_=>h(),["enter"]))},null,544),[[hn,C.value]])]),V("div",{class:"button",onClick:E[2]||(E[2]=_=>h())}," Change ")])]),V("div",YN,[JN,V("div",XN,[(Te(!0),Pe(He,null,Vn(S.value,_=>(Te(),Pe("div",{class:"itemsContainer",key:_.ID},[V("div",ZN,[V("div",eV,[ln(Ye(_.SUBJ)+" ",1),V("div",tV," #"+Ye(_.ID.substring(0,6).toUpperCase()),1)]),V("div",nV,[V("div",rV,Ye(_.DATE),1),V("div",sV,Ye(_.LOCATION),1),V("div",iV,Ye(i(_.TOD)),1),V("div",oV,Ye(_.MEMBERS.length)+" students ",1)]),V("div",aV,[V("div",{class:"button_white",onClick:m=>p(_.ID,_.SUBJ)}," Chat ",8,cV),V("div",{class:"button_white",onClick:m=>r(_.ID)}," Quit ",8,lV)])])]))),128))]),S.value.length==0?(Te(),Pe("div",uV," You're currently not part of any groups. ")):en("",!0)]),hV,V("div",dV,[fV,V("div",pV,[(Te(!0),Pe(He,null,Vn(k.value,_=>(Te(),Pe("div",{class:"itemsContainer",key:_.ID},[V("div",gV,[V("div",mV,Ye(_.SUBJ),1),V("div",_V,[V("div",yV,Ye(_.DATE),1),V("div",vV,Ye(_.LOCATION),1),V("div",EV,Ye(i(_.TOD)),1)]),V("div",TV,[V("div",{class:"button_white",onClick:m=>l(_.ID)}," Remove ",8,wV)])])]))),128))]),k.value.length==0?(Te(),Pe("div",IV," You currently have no study requests. ")):en("",!0)])]))}},bV=xr(AV,[["__scopeId","data-v-f219989a"]]),FE=t=>(Jn("data-v-b0dcf7cd"),t=t(),Xn(),t),RV={class:"frame"},SV=["data-channel","data-nickname"],CV={class:"infoBox"},PV=FE(()=>V("div",{class:"textBox"},[V("h2",null,"Rules:"),V("ol",null,[V("li",null,"Be respectful."),V("li",null,"Don't share personal information."),V("li",null,"Meet in a public place."),V("li",null,"Stay on topic"),V("li",null,"No Harassment or Discrimination")])],-1)),kV={class:"groupDisplay"},OV=FE(()=>V("p",null,"In this group:",-1)),DV={class:"costudentNames"},NV={__name:"GroupChat",setup(t){const e=_h(),n=e.params.channel,r=e.query.chatName,s=e.query.ID,i=qe([]),o=qe([]);cn(at,"groups");const c=cn(at,"users");ps(()=>{const h=document.getElementById("tlkio"),p=h.getAttribute("data-env")||"production",g=h.getAttribute("data-theme"),w=h.getAttribute("data-custom-css"),C=h.getAttribute("data-nickname"),M=document.createElement("iframe");let D=`https://embed.tlk.io/${n}`;const U=[];p==="dev"&&(D=`https://embed.lvh.me:3000/${n}`),w&&w.length&&U.push(`custom_css_path=${w}`),C&&C.length&&U.push(`nickname=${C}`),g&&g.length&&U.push(`theme=${g}`),U.length&&(D+=`?${U.join("&")}`),M.setAttribute("src",D),M.setAttribute("width","100%"),M.setAttribute("height","100%"),M.setAttribute("frameborder","0"),M.setAttribute("style","margin-bottom: -8px;");const O=h.getAttribute("style");h.setAttribute("style",`overflow: auto; -webkit-overflow-scrolling: touch; ${O}`),h.textContent="",h.appendChild(M);const S=document.createElement("style");S.textContent=`
      .tlkio-pulse {
        width: 70px;
    ...
    `;const k=document.createElement("img");k.src="https://www.tlk.io/images/logo.png",k.className="tlkio-pulse",window.getComputedStyle(h).position==="static"&&(h.style.position="relative"),h.appendChild(S),h.appendChild(k),setTimeout(()=>{h.removeChild(k),h.removeChild(S)},3e3)});async function l(h){const p=Un(at,"groups",h),g=await fc(p);i.value=g.data().MEMBERS,u(i.value)}async function u(h){for(let p=0;p<h.length;p++){const g=Bn(c,Ot("UID","==",h[p])),w=await $n(g);o.value.push(w.docs[0].data().NAME)}}return l(s),(h,p)=>(Te(),Pe("div",RV,[V("div",{id:"tlkio","data-channel":st(n),"data-theme":"theme--minimal","data-nickname":st(r)},null,8,SV),V("div",CV,[PV,V("div",kV,[OV,V("div",DV,[(Te(!0),Pe(He,null,Vn(o.value,g=>(Te(),Pe("div",{class:"name",key:o.value},[V("p",null,Ye(g),1)]))),128))])])])]))}},VV=xr(NV,[["__scopeId","data-v-b0dcf7cd"]]),UE=Pb({history:ib("/costudent-demo/"),routes:[{path:"/",name:"home",component:nP},{path:"/findcostudent",name:"findcostudent",component:qN,meta:{requiresAuth:!0}},{path:"/login",name:"login",component:ND},{path:"/register",name:"register",component:UD},{path:"/dashboard",name:"dashboard",component:bV,meta:{requiresAuth:!0}},{path:"/group-chat/:channel",name:"group-chat",component:VV,meta:{requiresAuth:!0}}]});let Lg=!1,Hl=!1;UE.beforeEach((t,e,n)=>{const r=li(),s=t.matched.some(i=>i.meta.requiresAuth);Lg?s&&!Hl?(alert("No access! You need to be logged in."),n("/login")):n():Cy(r,i=>{Hl=!!i,Lg=!0,s&&!Hl?(alert("No access! You need to be logged in."),n("/login")):n()})});const rl=O_(KC);rl.config.globalProperties.$firebase=nl;rl.use(UE);rl.use(PC,{position:"bottom-right",duration:5e3,pauseOnHover:!0});rl.mount("#app");
